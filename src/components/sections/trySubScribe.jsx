...
import funFlip from '../../assets/images/fun-flip-icon.svg';
...
import tryBackgroun from '../../assets/images/tryBg.svg'
            ...
            <div className="flex justify-center items-center flex-col gap-3 mx-auto">
                ...
                >
                    <div className="flex flex-col items-center gap-[20px]">
                        <h2 className='text-[52.74px] leading-[110%] tracking-[-1.34px] font-bold text-white text-center max-w-[560px] text-white max-sm:text-[40px] max-sm:text-center max-sm:w-[300px]'>Try SubScribe now</h2>
                    </div>
                    <div className="flex gap-[20px] max-sm:flex-col">
                        <button className='text-[16.53px] bg-white text-[#2B44E7] cursor-pointer py-[18px] px-8 rounded-[8px]'>Get Started now</button>
                ...
                <div className="bg-[#F7F7F7] h-[250px] flex justify-center items-center rounded-[32px] max-w-[1276.8px] w-full px-6">
                    <div className="flex flex-col items-center gap-11 w-full mx-auto">
                        <div className='flex max-w-[1177px] w-full justify-between items-center max-sm:flex-col max-sm:gap-6'>
                            <div className="logo">

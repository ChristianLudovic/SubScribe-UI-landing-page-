            ...
            <div className="hero-section px-8 pb-[100px] max-sm:px-4 max-sm:pb-[70px]">
                <div className="hero-section-content flex flex-col items-center pt-[110px] mx-auto max-w-[1276.8px] max-sm:pt-[101px]">
                    ...
                    <div className="description flex flex-col justify-center">
                        <p className="text-[24.8px] text-white text-center font-normal leading-[150%] mb-[40px] max-w-[655px] max-sm:w-[380px] max-sm:text-[20px]">An intuitive platform to manage all your<br/> subscriptions, freeing up your time for what matters most: enjoying.</p>
